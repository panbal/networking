...
variable "secret_key" {
  default = "ZBAbfkHtNfC8/2iDJ0DtdaFatdLK1gfgfg"
  sensitive = true
}
...
variable "tgwaz1ip" {
  default = "192.168.50.64/28"
}

variable "tgwaz2ip" {
  default = "192.168.51.64/28"
}

variable "vpccidr" {
  default = "192.168.50.0/23"
}
...
variable "hasynccidraz1" {
  default = "192.168.50.32/28"
}

variable "hamgmtcidraz1" {
  default = "192.168.50.48/28"
}

variable "publiccidraz2" {
  default = "192.168.51.16/28"
}

variable "privatecidraz2" {
  default = "192.168.51.0/28"
}

variable "hasynccidraz2" {
  default = "192.168.51.32/28"
}

variable "hamgmtcidraz2" {
  default = "192.168.51.48/28"
}
...
variable "passiveport3" {
  default = "192.168.51.40"
}


variable "passiveport4" {
  default = "192.168.51.55"
}